    ...
    try:
        ...
        try:
            ...
            cost_per_gram = Decimal(
                str(get_setting("cost_engine_cost_per_gram", "0.025"))
            )
        except Exception:
            pass
        ...
        if asset.product and asset.parsed_print_minutes:
            asset.product.estimated_print_minutes = int(
                round(float(asset.parsed_print_minutes))
            )
