...
class Config:
    ...
    OPENAI_MODEL_MARKET_CATALOG = os.getenv(
    ...
    KILO_GATEWAY_BASE_URL = os.getenv("KILO_GATEWAY_BASE_URL", "https://api.kilo.ai/api/gateway")
    KILO_MODEL = os.getenv("KILO_MODEL", "anthropic/claude-sonnet-4.5")
    KILO_MODEL_RECEIPTS = os.getenv("KILO_MODEL_RECEIPTS", KILO_MODEL)
    KILO_MODEL_ANALYTICS = os.getenv("KILO_MODEL_ANALYTICS", KILO_MODEL)
    KILO_MODEL_TREND_SCOUT = os.getenv("KILO_MODEL_TREND_SCOUT", KILO_MODEL)
    KILO_MODEL_MARKET_CATALOG = os.getenv("KILO_MODEL_MARKET_CATALOG", KILO_MODEL)
    KILO_MODEL_PRODUCT_STORY = os.getenv("KILO_MODEL_PRODUCT_STORY", KILO_MODEL)
    ...
    AUDIT_OUTBOX_REPLAY_INTERVAL_SECONDS = int(
        os.getenv("AUDIT_OUTBOX_REPLAY_INTERVAL_SECONDS", "60")
    )
