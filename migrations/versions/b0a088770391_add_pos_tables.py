...
def upgrade():
    ...
    op.create_index(op.f('ix_pos_sale_items_variant_id'), 'pos_sale_items', ['variant_id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_pos_sale_items_variant_id'), table_name='pos_sale_items')
