...
def upgrade():
    ...
    with op.batch_alter_table("products", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_products_collection_id"), ["collection_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("designer_name", sa.String(length=160), nullable=True),
        sa.Column("license_type", sa.String(length=160), nullable=True),
        ...
        sa.Column("proof_of_license_path", sa.String(length=255), nullable=True),
    ...
    with op.batch_alter_table("model_assets", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_model_assets_related_product_id"), ["related_product_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("estimated_print_minutes", sa.Integer(), nullable=False),
        sa.Column("estimated_filament_grams", sa.Integer(), nullable=False),
        sa.Column("active", sa.Boolean(), nullable=False),
        sa.Column("pos_button_label", sa.String(length=120), nullable=True),
        sa.Column("pos_sort_order", sa.Integer(), nullable=False),
        sa.Column("barcode_or_qr_code", sa.String(length=255), nullable=True),
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
    ...
    with op.batch_alter_table("inventory_records", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_inventory_records_location_id"), ["location_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_inventory_records_product_id"), ["product_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_inventory_records_variant_id"), ["variant_id"], unique=False
        )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("inventory_records", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_inventory_records_variant_id"))
    ...
    with op.batch_alter_table("model_assets", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_model_assets_related_product_id"))
