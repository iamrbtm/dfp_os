...
def _fetch_with_serpapi(session: requests.Session, limiter: Any, api_key: str) -> list[ScoutResult]:
    ...
    for query in SEED_QUERIES:
        ...
        try:
            ...
            results.append(ScoutResult(source="google_trends", keyword_or_category=query, errors=[str(exc)]))
    return results
    ...
    try:
        ...
        return [
            ScoutResult(
                ...
                errors=["Set SERPAPI_API_KEY or install/configure pytrends to enable Google Trends data."],
