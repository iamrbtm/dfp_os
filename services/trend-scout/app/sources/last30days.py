...
DEFAULT_RAW_FILE = os.path.expanduser("~/Documents/Last30Days/3d-printing-ideas-what-people-buy-sell-raw-v3.md")
    ...
    if not clusters:
        return [
            ScoutResult(
                source="last30days",
                keyword_or_category="pipeline_error",
                errors=[f"No evidence clusters found in {raw_file}. The raw file format may have changed."],
            )
        ]
