...
def _parse_rss_item(item_el: Any) -> dict[str, Any]:
    ...
    title_el = item_el.find("rss:title", ns) or item_el.find("title") or item_el.find("atom:title", ns)
    link_el = item_el.find("rss:link", ns) or item_el.find("link") or item_el.find("atom:link", ns)
    desc_el = item_el.find("rss:description", ns) or item_el.find("description") or item_el.find("atom:content", ns)
